...
const u32 gTrainerFrontPic_Yoyo[] = INCBIN_U32("graphics/trainers/front_pics/yoyo.4bpp.lz");
const u32 gTrainerPalette_Yoyo[] = INCBIN_U32("graphics/trainers/palettes/may_rs.gbapal.lz");
